    ...
    <div className="fixed inset-0 z-50 overflow-hidden">
      ...
      <div className="absolute inset-y-0 right-0 max-w-2xl w-full flex">
        <div className="w-full h-full bg-[#0a0a0f] border-l border-white/10 shadow-2xl flex flex-col transform transition-transform duration-500 ease-in-out">
          ...
          {/* Header */}
          <div className="px-4 md:px-6 py-4 md:py-5 border-b border-white/10 flex items-center justify-between bg-white/5">
          ...
          {/* Form Content */}
          <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto custom-scrollbar p-4 md:p-6 flex flex-col gap-4 md:gap-6">
          ...
          {/* Footer Actions */}
          <div className="px-4 md:px-6 py-4 border-t border-white/10 bg-white/5 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3 w-full sm:w-auto justify-end">
              <button 
                type="button"
                onClick={onClose}
                className="px-5 py-2.5 rounded-xl font-medium text-gray-400 hover:text-white hover:bg-white/5 transition-colors flex-1 sm:flex-none text-center"
              >
                Cancel
              </button>
              ...
              <button 
                ...
                disabled={isSaving}
                className="flex items-center justify-center gap-2 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-500 hover:to-blue-500 text-white px-6 py-2.5 rounded-xl font-medium shadow-lg shadow-purple-500/25 transition-all transform hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed flex-1 sm:flex-none"
              >
                {isSaving ? (
